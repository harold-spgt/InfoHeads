...
public final class PlayerCommandInput extends StringPrompt {

    private final InfoHeads plugin;

    public PlayerCommandInput(final InfoHeads plugin) {
        this.plugin = plugin;
    }
    ...
    public Prompt acceptInput(ConversationContext context, String input) {
        plugin.getDataStore().getDraft((Player) context.getForWhom()).addElement(new PlayerCommandElement(input));
